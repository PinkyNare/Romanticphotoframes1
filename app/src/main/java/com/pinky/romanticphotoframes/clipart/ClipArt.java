package com.pinky.romanticphotoframes.clipart;
...
public class ClipArt extends RelativeLayout {
    ...
    public ImageButton btnscl, clp_edit_txt;

    EditingActivity cntx;
    ...
    public static boolean visablecheck = false;


    public int color_t = Color.WHITE;
    public String txt_t;
    public Typeface typeface_t = Typeface.DEFAULT;


    public ClipArt(EditingActivity paramContext, Bitmap bl, int colorr, Typeface typeface, String s) {
        super(paramContext);
        cntx = paramContext;
        layGroup = this;
        basex = 0;
        ...
        clp_edit_txt = ((ImageButton) findViewById(R.id.clp_edit_txt));
        imgring = ((ImageView) findViewById(R.id.image));
        layoutParams = new LayoutParams((int) (Utils.scwidth_u / 1.5), (int) (Utils.scwidth_u / 2.5));
        ...
        img_params.width = Utils.scwidth_u / 2;
        img_params.height = Utils.scwidth_u / 5;

        android.view.ViewGroup.LayoutParams del_params = btndel.getLayoutParams();
        del_params.width = Utils.scwidth_u / 12;
        del_params.height = Utils.scwidth_u / 12;

        android.view.ViewGroup.LayoutParams rot_params = btnrot.getLayoutParams();
        rot_params.width = Utils.scwidth_u / 12;
        rot_params.height = Utils.scwidth_u / 12;

        android.view.ViewGroup.LayoutParams sc_params = btnscl.getLayoutParams();
        sc_params.width = Utils.scwidth_u / 12;
        sc_params.height = Utils.scwidth_u / 12;

        android.view.ViewGroup.LayoutParams edit_params = clp_edit_txt.getLayoutParams();
        edit_params.width = Utils.scwidth_u / 12;
        edit_params.height = Utils.scwidth_u / 12;
        ...
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View paramAnonymousView, MotionEvent event) {
                ...
                EditingActivity.prfile_lay.setVisibility(View.GONE);
                ...
                if (!ClipArt.this.freeze) {
                    switch (event.getAction()) {
                        ...
                        case MotionEvent.ACTION_MOVE:
                            ...
                            layoutParams.rightMargin = -(int) 9999999;
                            layoutParams.bottomMargin = -(int) 9999999;
                            layGroup.setLayoutParams(layoutParams);
                            break;
        ...
        this.clp_edit_txt.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                cntx.showtextVisible_click();
            }
        });
    ...
    public void disableAll() {
        ...
        clp_edit_txt.setVisibility(View.INVISIBLE);
    ...
    public void visiball() {
        ...
        this.clp_edit_txt.setVisibility(View.VISIBLE);
